...
interface Props {
    handleChange:(e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>,type:string) => void;
    ...
    return (
        <>
            ...
            <div>
                ...
                <select name="hospital" onChange={e=>handleChange(e,'formFields')} className={styles.input}>
